...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR blue][B]DrxipZ[/B][/COLOR]Wiz'
BUILDERNAME = 'M0rpheas'
EXCLUDES = [ADDON_ID, 'repository.DrxipZFlixZ']
# Text File with build info in it.
BUILDFILE = 'https://raw.githubusercontent.com/DrxipZFlixZ/BuildFiles/main/BUILD%20FILE/builds.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]DrxipZ[/B][/COLOR][COLOR {color2}]Wiz[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR blue][B]DrxipZ[/B][/COLOR]Wiz'
